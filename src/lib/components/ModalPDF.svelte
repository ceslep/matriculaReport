...
{#if isOpen && pdfUrl}
  ...
  >
    <div
      class="bg-white rounded-lg shadow-2xl w-full max-w-5xl h-[90vh] flex flex-col"
    >
      <!-- Header del modal -->
      <div
        class="flex items-center justify-between px-4 py-3 border-b bg-gray-50 rounded-t-lg"
      >
      ...
      <!-- Footer con botones -->
      <div
        class="flex items-center justify-end gap-3 px-4 py-3 border-t bg-gray-50 rounded-b-lg"
      >
        <button
          onclick={onClose}
